...
void pci_append_device(uint8_t bus, uint8_t slot, uint8_t function, struct pci_device *devices, uint32_t *device_count, uint32_t max_devices) {
...
const struct class_code class_codes[22] = {
    ...
    {0x01,
     ...
     {{0x00, "SCSI Bus Controller", 0, {}},
      ...
      {0x05, "ATA Controller", 2, {{0x20, "Single DMA"}, {0x30, "Chained DMA"}}},
      {0x06, "Serial ATA Controller", 3, {{0x0, "Vendor Specific Interface"}, {0x01, "AHCI 1.0"}, {0x02, "Serial Storage Bus"}}},
      {0x07, "Serial Attached SCSI Controller", 2, {{0x0, "SAS"}, {0x1, "Serial Storage Bus"}}},
      {0x08, "Non-Volatile Memory Controller", 2, {{0x1, "NVMHCI"}, {0x2, "NVM Express"}}},
      {0x80, "Other", 0, {}}}},
    {0x02,
     "Network Controller",
     10,
    ...
    {0x03,
     "Display Controller",
     4,
     {{0x00, "VGA Compatible Controller", 2, {{0x0, "VGA Controller"}, {0x1, "8514-Compatible Controller"}}},
    ...
    {0x4,
     ...
     {{0x0, "Multimedia Video Contoller", 0, {}},
      ...
      {0x3, "Audio Device", 0, {}},
      {0x80, "Other", 0, {}}}},
    {0x5, "Memory Controller", 3, {{0x0, "RAM Controller", 0, {}}, {0x1, "Flash Controller", 0, {}}, {0x80, "Other", 0, {}}}},
    {0x6,
     "Bridge",
     12,
     {{0x0, "Host Bridge", 0, {}},
      ...
      {0x2, "EISA Bridge", 0, {}},
      {0x3, "MCA Bridge", 0, {}},
      {0x4, "PCI-to-PCI Bridge", 2, {{0x0, "Normal Decode"}, {0x1, "Subtractive Decode"}}},
      {0x5, "PCMCIA Bridge", 0, {}},
      {0x6, "NuBus Bridge", 0, {}},
      {0x7, "CardBus Bridge", 0, {}},
      {0x8, "RACEway Bridge", 2, {{0x0, "Transparent Mode"}, {0x1, "Endpoint Mode"}}},
      {0x9,
       "PCI-to-PCI Bridge",
       2,
       {{0x40, "Semi-Transparent, Primary bus towards host CPU"}, {0x80, "Semi-Transparent, Secondary bus towards host CPU"}}},
    ...
    {0x8,
     ...
     {{0x0,
      ...
      {0x1, "DMA Controller", 3, {{0x0, "Generic 8237"}, {0x1, "ISA DMA Controller"}, {0x2, "EISA DMA Controller"}}},
      {0x2, "System Timer", 4, {{0x0, "Generic 8254"}, {0x1, "ISA System Timer"}, {0x2, "EISA System Timer"}, {0x3, "HPET"}}},
      {0x3, "RTC Controller", 2, {{0x0, "Generic RTC"}, {0x1, "ISA-Compatible"}}},
    ...
    {0x9,
     ...
     {{0x0, "Keyboard Controller", 0, {}},
      ...
      {0x4, "Gameport Controller", 2, {{0x0, "Generic"}, {0x1, "Extended"}}},
      {0x80, "Other", 0, {}}}},
    {0xA, "Docking Station", 2, {{0x0, "Generic", 0, {}}, {0x80, "Other", 0, {}}}},
    {0xB,
     "Processor",
     7,
     {{0x0, "386", 0, {}},
    ...
    {0xC,
     ...
     10,
     {{0x0, "FireWire (IEEE 1394)", 2, {{0x0, "Generic"}, {0x10, "OHCI"}}},
      {0x1, "ACCESS Bus", 0, {}},
      {0x2, "SSA", 0, {}},
      {0x3,
       "USB Controller",
       6,
       {{0x0, "UHCI"}, {0x10, "OHCI"}, {0x20, "EHCI"}, {0x30, "XHCI"}, {0x80, "Unspecified"}, {0xFE, "USB Device (Not a host controller)"}}},
      {0x4, "Fibre Channel", 0, {}},
      {0x5, "SMBus", 0, {}},
      {0x6, "InfiniBand", 0, {}},
      {0x7, "IPMI Interface", 3, {{0x0, "SMIC"}, {0x1, "Keyboard Controller Style"}, {0x2, "Block Transfer"}}},
    ...
    {0xD,
     ...
     {{0x0, "iRDA Compatible Controller", 0, {}},
      ...
      {0x80, "Other", 0, {}}}},
    {0xE, "Intelligent Controller", 1, {{0x0, "I20", 0, {}}}},
    {0xF,
    ...
    {0x12,
     ...
     3,
     {{0x0, "Processing Accelerator", 0, {}}, {0x1, "AI Inference Accelerator", 0, {}}, {0x10, "Signal Processing Accelerator", 0, {}}}},
    {0x13,
...
void pci_get_description(const struct pci_device *device, const char **class_name, const char **subclass_name, const char **prog_if_name) {
    ...
    for (; class_index < class_code_size; ++class_index) {
        if (device->class_code == class_codes[class_index].class_code) {
            if (class_name != NULL) {
                *class_name = class_codes[class_index].class_code_name;
            }
            break;
        }
    }
    ...
    for (; subclass_index < class_codes[class_index].subclass_size; ++subclass_index) {
        if (device->subclass == class_codes[class_index].subclasses[subclass_index].subclass) {
            if (subclass_name != NULL) {
                *subclass_name = class_codes[class_index].subclasses[subclass_index].subclass_name;
            }
            break;
        }
    }
    ...
    for (; prog_if_index < class_codes[class_index].subclasses[subclass_index].prog_if_size; ++prog_if_index) {
        if (device->prog_if == class_codes[class_index].subclasses[subclass_index].prog_ifs[prog_if_index].prog_if) {
            if (prog_if_name != NULL) {
                *prog_if_name = class_codes[class_index].subclasses[subclass_index].prog_ifs[prog_if_index].prog_if_name;
            }
            break;
        }
    }
